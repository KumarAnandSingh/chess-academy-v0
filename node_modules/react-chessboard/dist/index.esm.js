...
function ChessboardProvider({ children, options, }) {
    ...
    return (jsx(ChessboardContext.Provider, { value: {
            ...
            drawArrow,
            clearArrows,
        }, children: jsx(DndContext, { autoScroll: allowAutoScroll, collisionDetection: collisionDetection, onDragStart: handleDragStart, onDragEnd: handleDragEnd, onDragCancel: handleDragCancel, sensors: sensors, children: children }) }));
}
