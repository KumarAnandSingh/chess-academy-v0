...
function ChessboardProvider({ children, options, }) {
    ...
    return (jsxRuntime.jsx(ChessboardContext.Provider, { value: {
            ...
            drawArrow,
            clearArrows,
        }, children: jsxRuntime.jsx(DndContext, { autoScroll: allowAutoScroll, collisionDetection: collisionDetection, onDragStart: handleDragStart, onDragEnd: handleDragEnd, onDragCancel: handleDragCancel, sensors: sensors, children: children }) }));
}
